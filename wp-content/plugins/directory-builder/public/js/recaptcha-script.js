( function( $, gglcptch ) {
	...
	$( document ).ready( function() {
		...
		$( 'form:not(.dt-register-form):not(#db-add-listing-form)' ).not( '[name="loginform"], [name="registerform"], [name="lostpasswordform"], #setupform, .cntctfrmpr_contact_form, .cntctfrm_contact_form, #commentform, #gglcptch_admin_settings_page' ).submit( function( e ) {
			var $form = $( this ),

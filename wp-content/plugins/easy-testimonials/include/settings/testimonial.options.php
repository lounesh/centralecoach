...
{	
					...
					<div class="bottom_cols">
						<div class="how_to_upgrade">
							...
							<ol>
								...
								<li>Receive your API Key instantly</li>
								<li>Go to Easy Testimonials Settings &raquo; Basic Settings &raquo; <a href="<?php echo admin_url('admin.php?page=easy-testimonials-settings#tab-registration_options'); ?>">Registration Options</a> and enter your API Key.</li>
							</ol>
							<p class="upgrade_more">That's all! Upgrading takes just a few moments, and won't affect your data.</p>
						</div>
						<div class="questions">
							<h4>Already purchased?</h4>
							<p class="questions_text"><a href="<?php echo admin_url('admin.php?page=easy-testimonials-settings#tab-registration_options'); ?>">Simply enter your API Key here to upgrade</a>.</p>
				...
				<div id="signup_wrapper" class="upgrade_sidebar">
					<div id="mc_embed_signup">
						...
						<form action="https://goldplugins.com/atm/atm.php?u=403e206455845b3b4bd0c08dc&amp;id=a70177def0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate="">
							...
							<p class="secure"><img src="http://future.theslatch.com/wp-content/plugins/easy-testimonials/include/assets/img/lock.png" alt="Lock" width="16px" height="16px">We respect your privacy.</p>
	...
	function easy_t_admin_tabs($current = 'homepage' ) {
		...
		$tabs = array( 	'easy-testimonials-settings' => __('Basic', 'easy-testimonials'), 
						...
						'easy-testimonials-upgrade-to-pro' => __('Upgrade', 'easy-testimonials')
					);

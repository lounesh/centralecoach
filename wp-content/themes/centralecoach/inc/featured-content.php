 ...
 */
class Whitelab_Featured_Content {
	 ...
	 *
	 * @see Whitelab_Featured_Content::init()
	 *
	 * @since WhiteLab 1.0
	 *
	 * @static
	 ...
	 *
	 * @see WhiteLab_Featured_Content::validate_settings().
	 *
	 * @static
	 * @access public
	 * @since WhiteLab 1.0
	 ...
	 * the transient is deleted by Whitelab_Featured_Content::validate_settings().
	 *
	 ...
	 *
	 * @uses Whitelab_Featured_Content::get_setting()
	 */
	...
	public static function customize_register( $wp_customize ) {
		$wp_customize->add_section( 'featured_content', array(
			'title'          => esc_html__( 'Featured Content', 'whitelab' ),
			'description'    => sprintf( wp_kses( __( 'Use the <a href="%1$s">"featured" tag</a> to feature your posts. You can change this to a tag of your choice; if no posts match the tag, <a href="%2$s">sticky posts</a> will be displayed instead.', 'whitelab' ), array( 'a' => array( 'href' => array() ) ) ), admin_url( '/edit.php?tag=featured' ), admin_url( '/edit.php?show_sticky=1' ) ),
			'priority'       => 130,
		...
		$wp_customize->add_control( 'featured-content[order]', array(
			'label'    => esc_html__( 'Post order', 'whitelab' ),
		...
		$wp_customize->add_control( 'featured-content[tag-name]', array(
			'label'    => esc_html__( 'Tag Name', 'whitelab' ),
			'section'  => 'featured_content',
			'priority' => 20,
		) );
		$wp_customize->add_control( 'featured-content[hide-tag]', array(
			'label'    => esc_html__( 'Don&rsquo;t display tag on front end.', 'whitelab' ),
			'section'  => 'featured_content',
			'type'     => 'checkbox',
			'priority' => 40,
		) );
		$wp_customize->add_control( 'featured-content[quantity]', array(
			'label'    => esc_html__( 'Post limit', 'whitelab' ),
			'section'  => 'featured_content',
			'priority' => 30,
		) );
	 ...
	 * delete the transient set in Whitelab_Featured_Content::get_featured_content().
	 *
	 * @static
	 * @access public
	 * @since WhiteLab 1.0
...
} // Whitelab_Featured_Content

Whitelab_Featured_Content::setup();